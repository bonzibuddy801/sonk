...
(function(ext) {
	...
	fillRect: function(x, y, width, height) { console.log("working..."); var args = [x, y, width, height]; console.log(args); events[events.length + 1] = QueuedEvent("fillRect",args); console.log(this.events); }
    };
    console.log(pane);
